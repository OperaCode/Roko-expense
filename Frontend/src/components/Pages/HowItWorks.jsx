          ...
          >
            ...
            <div className="w-full md:w-6/12 space-y-3 md:space-y-6">
              ...
              <p className="font-bodyFont text-base sm:text-lg md:text-xl text-center md:text-left">
                Meet Dave, As a medical doctor and the father of a growing family, Dave has a lot to keep track of. 
                With RoKo, he's able to manage his finances, stay on the same page with his family, and spend on 
                what's really important in life. This is his story.
              </p>
            </div>
