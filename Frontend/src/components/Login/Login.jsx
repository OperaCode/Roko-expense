...
const Login = () => {
  return (
    <main className="bg-indigo-500 background p-10 lg:h-screen">
      <div className="p-6 ">
            ...
            <form action="" className="">
              ...
              <div className="flex flex-col gap-4">
                ...
                <input
                  ...
                  required
                />
                <FaRegEye className="-mt-8 right-28 absolute flex justify-end  cursor-pointer " />
                </div>
              </div>

              <div className="flex justify-center pt-10">
                <button className="bg-indigo-700 text-white p-3 w-full font-semibold rounded">
                  Login
                </button>
              </div>
            </form>
